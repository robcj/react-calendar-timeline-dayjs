...
const items = [
  {
    ...
    end_time: dayjs('1995-12-25').add(1, 'hours'),
  },
  {
    id: 2,
    group: 2,
    title: 'item 2',
    start_time: dayjs('1995-12-25').add(-0.5, 'hours'),
    end_time: dayjs('1995-12-25').add(0.5, 'hours'),
  },
  {
    id: 3,
    group: 3,
    title: 'item 3',
    start_time: dayjs('1995-12-25').add(2, 'hours'),
    end_time: dayjs('1995-12-25').add(3, 'hours'),
  },
];
...
xdescribe('Timeline', () => {
  it('shows grouping no matter of the group order', () => {
    const wrapper = mount(
      <Timeline
        groups={groups}
        items={items}
        defaultTimeStart={dayjs('1995-12-25').add(-12, 'hours')}
        defaultTimeEnd={dayjs('1995-12-25').add(12, 'hours')}
      />
    );
  ...
  it('renders items without corresponding group', () => {
    let itemsNoValidGroup = [
      {
        start_time: dayjs('1995-12-25').add(-2, 'hours'),
        end_time: dayjs('1995-12-25').add(2, 'hours'),
